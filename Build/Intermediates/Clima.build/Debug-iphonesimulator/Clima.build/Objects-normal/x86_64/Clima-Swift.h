...
#ifndef CLIMA_SWIFT_H
#define CLIMA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Clima",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Clima11AppDelegate")
...
SWIFT_CLASS("_TtC5Clima13SceneDelegate")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tempLabelDegree;
- (void)viewDidLoad;
...
@interface WeatherViewController (SWIFT_EXTENSION(Clima)) <CLLocationManagerDelegate>
...
@interface WeatherViewController (SWIFT_EXTENSION(Clima)) <UITextFieldDelegate>
